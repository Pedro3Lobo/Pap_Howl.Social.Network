  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        <p class="login-box-msg">Inicie à Sessão</p>
        ...
        <a href="#"  onclick='myFunction()'>Esqueci-me da Palavra Passe</a><br>
    ...
    <script>
	  ...
	  function myFunction() {
		var person = prompt("Introduze o teu email:", "");

		if (person !=null) {
			window.location='email.php?email='+person+'';
		}
	}
